...
sys.path.append('.')
from tongui.data.dset_aitw import AitwDataset
from tongui.eval.eval_aitw_utils import validate_aitw

logging.basicConfig(level=logging.INFO)

'''
python src/eval/run_aitw.py \
    --model_path /mnt/bofeidisk2/Qwen2.5-VL-3B-Instruct/ \
...
def main():
    ...
    dataset_name = f"hf_test"
    if args.version == "v2":
        dataset_name = f"hf_test_with_thoughts"
    dataset = AitwDataset(
        args.dataset_dir,
        "AITW",
        dataset_name,
